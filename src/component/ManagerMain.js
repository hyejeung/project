...
import InProgressOrders from './InProgressOrders'; // 새로운 컴포넌트
  ...
  return (
    <div className="managermain-container">
      ...
      <div className="order-buttons">
        ...
        <button onClick={() => setSelectedTab('inProgress')}>처리중</button> {/* "처리중" 버튼 추가 */}
      ...
      {selectedTab === 'inProgress' && <InProgressOrders />} {/* "처리중" 컴포넌트 추가 */}
